...
const ServiceAreasCarousel = () => {
  ...
  return <div className="py-6 bg-gradient-to-r from-gray-100 via-white to-gray-100 overflow-hidden w-full bg-slate-900">
      <div className="relative w-full">
        <div ref={carouselRef} className="flex overflow-x-hidden scrollbar-none whitespace-nowrap w-full">
          ...
          {[...serviceAreas, ...serviceAreas, ...serviceAreas].map((area, index) => <div key={index} className="inline-flex px-4 py-2 mx-1">
