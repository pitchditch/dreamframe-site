...
export const Logo = ({ isOverVideo }: LogoProps) => {
  ...
  const mobileLogoHeight = 'h-14 w-auto'; // Increased from h-12 to h-14
  ...
  return (
    <Link to="/" className="flex items-center mr-auto z-20"> {/* Added z-20 to ensure logo is above other elements */}
      <div className="relative flex items-center transition-all duration-300 pt-2"> {/* Added pt-2 for mobile */}
        {isOverVideo ? (
          ...
          <img
            ...
            className={`${isMobile ? mobileLogoHeight : desktopLogoHeight} object-contain max-w-[280px] md:max-w-[420px] hover:scale-105 duration-300`}
