...
export const Logo = ({ isOverVideo }: LogoProps) => {
  return (
    <Link to="/" className="flex items-center">
      <div className="relative h-28 md:h-32 flex items-center transition-all duration-300">
        {isOverVideo ? (
          ...
          <img
            ...
            className="h-28 md:h-32 w-auto object-contain max-w-[350px] transition-transform hover:scale-105 duration-300"
