...
export const Logo = ({ isOverVideo }: LogoProps) => {
  return (
    <Link to="/" className="flex items-center">
      <div className="relative h-28 flex items-center transition-all duration-300">
        {isOverVideo ? (
          ...
          <div className="relative">
            ...
            <img
              ...
              className="h-full w-auto object-contain max-w-[350px] min-h-[110px] relative z-10"
            />
          </div>
        ) : (
          ...
          <img
            ...
            alt="BC Pressure Washing Property Maintenance logo"
            className="h-full w-auto object-contain max-w-[350px] min-h-[110px] transition-transform hover:scale-105 duration-300"
          />
        )}
      </div>
    </Link>
