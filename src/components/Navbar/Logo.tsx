...
export const Logo = ({ isOverVideo }: LogoProps) => {
  ...
  return (
    <Link to="/" className="flex items-center mr-auto">
      <div className="logo-container relative h-36 md:h-40 flex items-center perspective-1000">
        {isOverVideo ? (
          ...
          <img
            ...
            className={`h-36 md:h-40 w-auto object-contain max-w-[420px] hover:scale-105 duration-300 ${isSpinning ? 'animate-spin duration-5000' : ''}`}
