...
export const Logo = ({ isOverVideo }: LogoProps) => {
  return (
    <Link to="/" className="flex items-center">
      <div className="relative h-32 md:h-36 flex items-center transition-all duration-300">
        {isOverVideo ? (
          ...
          <img
            ...
            className="h-32 md:h-36 w-auto object-contain max-w-[400px] transition-transform hover:scale-105 duration-300"
