        ...
        {isOverVideo ? (
          ...
          <div className="relative">
            ...
            <img
              ...
              className="h-16 md:h-20 w-auto object-contain max-w-[350px] relative z-10"
            />
          </div>
        ) : (
          ...
          <img
            ...
            alt="BC Pressure Washing Property Maintenance logo"
            className="h-16 md:h-20 w-auto object-contain max-w-[350px] transition-transform hover:scale-105 duration-300"
          />
        )}
      </div>
    </Link>
