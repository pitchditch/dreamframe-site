  ...
  return (
    <>
      ...
      <div className="hidden md:block">
        <Link to="/calculator">
          <button className={`${isOverVideo ? "bg-white/20 hover:bg-white/40 text-white" : "bg-bc-red hover:bg-red-700 text-white"} px-4 py-2 rounded-md font-medium transition-colors ${getLanguageClass()}`}>
            {t('Get a Quote')}
          </button>
        </Link>
      </div>
