    ...
    >
      <div className="container mx-auto px-4 py-4">
        <nav className="flex flex-col space-y-4">
          <Link to="/" className="py-2 text-black hover:text-bc-red transition-colors">
            {t('Home')}
          </Link>
          ...
          <Link to="/blog" className="py-2 text-black hover:text-bc-red transition-colors">
            {t('Blog')}
          </Link>
          
          <Link to="/about" className="py-2 text-black hover:text-bc-red transition-colors">
            {t('About')}
          </Link>
          
          <Link to="/testimonials" className="py-2 text-black hover:text-bc-red transition-colors">
            {t('Testimonials')}
          </Link>
