  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 py-4">
          <nav className="flex flex-col space-y-4">
            <Link to="/why-us" className="flex items-center gap-2 py-3 px-2 text-black hover:text-bc-red transition-colors hover:bg-gray-50 rounded-md hover:scale-105">
            ...
            <div className="border-b border-gray-100 pb-2">
              <div 
                className="flex items-center justify-between py-3 px-2 text-black hover:text-bc-red transition-colors cursor-pointer hover:bg-gray-50 rounded-md hover:scale-105"
              ...
              <div className={`overflow-hidden transition-all duration-300 pl-4 ${
                ...
                <div className="flex flex-col space-y-4 border-l-2 border-gray-100 pl-4">
                  <Link to="/services/window-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/pressure-washing" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/gutter-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/roof-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
            ...
            <div className="border-b border-gray-100 pb-2">
              ...
              <div className={`overflow-hidden transition-all duration-300 pl-4 ${
                ...
                <div className="flex flex-col space-y-4 border-l-2 border-gray-100 pl-4">
                  <Link to="/services/commercial-window-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/commercial-pressure-washing" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/post-construction-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
            ...
            <Link to="/contact" className="py-3 px-2 text-black hover:text-bc-red transition-colors hover:bg-gray-50 rounded-md font-medium hover:scale-105">
              {t('Contact')}
            </Link>
            
            <div className="pt-4 flex flex-col gap-3 border-t border-gray-100">
              <a href="tel:7788087620" className="flex items-center justify-center gap-2 w-full bg-bc-red hover:bg-red-700 text-white py-3 px-4 rounded-lg font-medium text-center transition-all hover:scale-105">
                <Phone size={18} />
                778-808-7620
              </a>
              <LanguageSelector />
      ...
      <div className="fixed bottom-6 right-6 md:hidden z-50 flex flex-row gap-4 justify-end px-4">
        <a href="tel:7788087620" className="bg-bc-red text-white p-4 rounded-full shadow-lg hover:bg-red-700 transition-all hover:scale-110">
          <Phone size={24} />
        </a>
      </div>
    </>
