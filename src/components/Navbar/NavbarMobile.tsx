        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex flex-col space-y-4">
            <Link to="/why-us" className="flex items-center gap-2 py-3 px-2 text-black hover:text-bc-red transition-colors hover:bg-gray-50 rounded-md">
              <img src="/lovable-uploads/aa6c65c1-a6f5-4b3f-baac-ecc0679d3ce0.png" alt="Logo Icon" className="w-6 h-6 object-contain" />
            ...
            <div className="border-b border-gray-100 pb-2">
              ...
              <div className={`overflow-hidden transition-all duration-300 pl-4 ${
                ...
                <div className="flex flex-col space-y-4 border-l-2 border-gray-100 pl-4">
                  <Link to="/services/window-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                      <img src="/lovable-uploads/e09933f5-0a99-4b31-8ed0-dc797c35080d.png" alt="Window Cleaning Icon" className="w-10 h-10 object-cover" />
                    </div>
                    <span>{t('Window Cleaning')}</span>
                  </Link>
                  <Link to="/services/pressure-washing" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/gutter-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/roof-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
            ...
            <div className="border-b border-gray-100 pb-2">
              ...
              <div className={`overflow-hidden transition-all duration-300 pl-4 ${
                ...
                <div className="flex flex-col space-y-4 border-l-2 border-gray-100 pl-4">
                  <Link to="/services/commercial-window-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/commercial-pressure-washing" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
                  ...
                  <Link to="/services/post-construction-cleaning" className="flex items-center gap-2 text-black hover:text-bc-red transition-colors py-2 px-2 hover:bg-gray-50 rounded-md transform transition-transform hover:scale-105">
                    <div className="p-1.5 rounded-md flex items-center justify-center w-12 h-12">
