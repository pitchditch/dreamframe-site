...
const ChatAssistant = () => {
  ...
  return <div className="fixed bottom-6 right-6 z-[1000]">
      <Button onClick={() => setIsOpen(!isOpen)} className={`chat-button rounded-full p-6 shadow-lg bg-transparent ${isOpen ? 'hover:bg-bc-red/10' : 'hover:bg-transparent'}`} size="lg">
        {isOpen ? <X className="h-8 w-8 text-bc-red" /> : <div className="relative">
            <img alt="Chat Assistant" className="h-20 w-20 rounded-full border-2 border-white" src="/lovable-uploads/970932d4-f8db-4a50-92b1-3fe35f2d06a7.jpg" />
      ...
      {isOpen && <div className="absolute bottom-24 right-0 w-[350px] bg-white rounded-xl shadow-xl p-5">
