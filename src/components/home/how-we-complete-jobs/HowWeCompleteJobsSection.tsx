...
const HowWeCompleteJobsSection = () => {
  ...
  return (
    <section className={`${isMobile ? 'py-12' : 'py-16 md:py-20'} bg-white`}>
      <div className="container mx-auto px-4">
        ...
        <div className={`text-center ${isMobile ? 'mb-8' : 'mb-12 md:mb-16'}`}>
          ...
          <h2 className={`${isMobile ? 'text-2xl px-4' : 'text-3xl md:text-4xl lg:text-5xl'} font-bold mb-4 md:mb-6 text-gray-900`}>
            {t("How We Complete Our Jobs")}
          </h2>
          <p className={`${isMobile ? 'text-base px-4' : 'text-lg md:text-xl'} text-gray-600 max-w-4xl mx-auto leading-relaxed ${isMobile ? 'mb-4' : ''}`}>
            {isMobile 
      ...
      {/* Full-width Carousel with mobile padding to prevent arrow overlap */}
