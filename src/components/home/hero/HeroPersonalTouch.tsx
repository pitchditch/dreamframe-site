...
const HeroPersonalTouch = () => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-start justify-start gap-4 ${isMobile ? 'my-8 mb-24' : 'my-12 mb-28'} animate-on-scroll delay-700 ${isMobile ? 'max-w-full' : ''}`}>
