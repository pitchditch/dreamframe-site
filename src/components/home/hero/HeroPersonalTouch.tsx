...
const HeroPersonalTouch = () => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-start justify-start gap-4 ${isMobile ? 'my-2 mb-4' : 'my-3 mb-5'} animate-on-scroll delay-700 ${isMobile ? 'max-w-full' : 'max-w-3xl'}`}>
