...
const FounderSection = () => {
  return (
    <section className="py-16 bg-white relative founder-section">
          ...
          <div className="md:col-span-4 order-2 md:order-1">
            <div className="relative">
              <img 
                ...
                className="w-full max-w-[200px] h-auto rounded-2xl border-4 border-bc-red shadow-lg mx-auto"
              />
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">We use the best tools for superior results.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Peace of mind comes standard. We're covered.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Local & Transparent</h3>
                    <p className="text-gray-700">No upsells. Just honest service from a neighbor who cares.</p>
                  </div>
                </div>
              </div>
            </div>
