...
const FounderSection = () => {
  return (
    <section className="py-32 bg-white relative mt-32">
      {/* Enhanced Founder Portrait with Design Elements */}
      <div className="absolute left-1/4 transform -translate-x-1/2 -top-32 z-20">
        <div className="relative w-64 h-64">
          {/* Add glow effect behind portrait */}
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 max-w-6xl mx-auto">
          <div className="md:col-span-6">
            <div className="space-y-6 bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl shadow-sm">
          ...
          <div className="md:col-span-6">
            <div className="space-y-8 relative">
              {/* Add design element - decorative line */}
