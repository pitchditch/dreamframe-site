      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full flex flex-col"
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 hover:text-bc-red transition-colors">
                  {service.title}
                </h3>
                ...
                <div className="mt-auto">
                  <Link 
                    to={service.link} 
                    className="inline-flex items-center text-bc-red hover:text-red-700 font-semibold transition-all duration-200 group"
                  >
                    {t("Learn More")} 
