...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section relative h-screen w-full overflow-hidden">
      ...
      {/* Hero Content */}
      <div className={`container mx-auto px-4 h-full flex flex-col justify-center relative z-10 text-white ${isMobile ? 'pt-8 sm:pt-12' : 'pt-20 sm:pt-24 md:pt-28'} ${videoLoaded && !isLoading ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700`}>
