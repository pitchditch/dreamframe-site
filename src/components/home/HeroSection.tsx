...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section relative h-screen w-full overflow-hidden">
      ...
      <div className={`container mx-auto px-4 h-full flex flex-col justify-center items-start relative z-10 text-white ${videoLoaded && !isLoading ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700`} style={{ paddingTop: isMobile ? '12vh' : '14vh', paddingBottom: isMobile ? '12vh' : '14vh' }}>
