  ...
  return <div className="w-full flex flex-col items-center">
      <div className="relative bg-gradient-to-tr from-blue-950/90 to-bc-red/40 p-2 rounded-xl shadow-2xl overflow-hidden w-full mx-auto">
        ...
        <div className="h-[450px] w-full rounded-xl overflow-hidden relative">
          <iframe src={`https://www.google.com/maps/d/embed?mid=${mapId}`} width="100%" height="100%" title="BC Pressure Washing Service Area" style={{
          border: 0,
        ...
        <div className="absolute bottom-4 right-4 perspective-1000">
          <img alt="BC Pressure Washing" className="transform-style-preserve-3d w-24 h-24" style={{
