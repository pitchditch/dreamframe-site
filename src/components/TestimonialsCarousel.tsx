  ...
  return (
    <section className="bg-gray-50 py-16 w-full">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-2">What Our Clients Say</h2>
        <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto text-lg md:text-xl">
            ...
            {allTestimonials.map((testimonial) => (
              ...
              >
                <div className="max-w-6xl mx-auto">
                  <div className="relative bg-white rounded-xl shadow-lg p-8 md:p-12 lg:p-16 overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 relative z-10">
                      <div className="flex flex-col justify-center">
                        {/* Quote */}
                        <div className="mb-6">
                          <svg className="w-12 h-12 md:w-16 md:h-16 text-bc-red" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-gray-700 italic mb-8 text-xl md:text-2xl lg:text-3xl leading-relaxed">{testimonial.quote}</p>
                        
                        {/* Profile */}
                        <div className="flex items-center">
                          {testimonial.profileImage ? (
                            <div className="mr-6">
                              <div className="h-24 w-24 md:h-32 md:w-32 border-2 border-gray-200 rounded-full overflow-hidden">
                                <img 
                            ...
                            <div className="mr-6">
                              <div className="h-24 w-24 md:h-32 md:w-32 bg-bc-red/20 text-bc-red border-2 border-gray-200 rounded-full flex items-center justify-center">
                                <span className="text-2xl md:text-3xl font-bold">{testimonial.name.charAt(0)}</span>
                              </div>
                            </div>
                          )}
                          <div>
                            <h4 className="font-semibold text-xl md:text-2xl lg:text-3xl">{testimonial.name}</h4>
                            {testimonial.location && <p className="text-gray-500 text-lg md:text-xl">{testimonial.location}</p>}
                            
                            {/* Rating stars */}
                            <div className="flex mt-2">
                              {[...Array(testimonial.rating)].map((_, i) => (
                                <svg key={i} className="w-5 h-5 md:w-6 md:h-6 fill-yellow-500 text-yellow-500" viewBox="0 0 24 24">
                                  <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                                </svg>
                              ))}
                              {[...Array(5 - testimonial.rating)].map((_, i) => (
                                <svg key={i + testimonial.rating} className="w-5 h-5 md:w-6 md:h-6 text-gray-300" viewBox="0 0 24 24">
                                  <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                                </svg>
                              ))}
                            </div>
                      ...
                      {/* Before/After Image - Much larger on desktop */}
                      {testimonial.beforeAfterImage && (
                        <div className="h-80 md:h-96 lg:h-[500px] xl:h-[600px] rounded-lg overflow-hidden">
                          <img 
        ...
        <div className="text-center">
          <Button asChild variant="bc-red" className="text-lg px-8 py-4">
