...
const beforeAfterImages: BeforeAfterImage[] = [
  {
    ...
    description: 'Crystal clear window restoration in White Rock',
    category: 'windows',
    location: 'White Rock'
  },
  {
    ...
    title: 'Roof Cleaning',
    description: 'Complete roof moss and algae removal in Surrey',
    category: 'roofs',
    location: 'Surrey'
  },
  {
    ...
    description: 'Professional pressure washing for concrete driveways',
    category: 'driveways',
    location: 'Langley'
  },
  {
    ...
    title: 'House Washing',
    description: 'Complete exterior house soft washing in South Surrey',
    category: 'house',
  ...
  {
    before: '/lovable-uploads/f88d2522-f185-44e9-93ae-7bbd157d3937.png',
    after: '/lovable-uploads/0523b00f-b3b1-4136-97c6-3c2dbb6b1809.png',
    title: 'Fence Cleaning',
    description: 'Fence pressure washing and restoration',
    category: 'fences',
    location: 'Surrey'
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Real before and after photos from our work across Metro Vancouver
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {categories.map((category) => (
              <Button
                ...
                variant={selectedCategory === category.id ? "bc-red" : "outline"}
                size="sm"
                className="mb-2"
              >
                {category.label}
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  {currentImage.location && (
                    <p className="text-sm text-bc-red font-semibold">
                      📍 {currentImage.location}
                    </p>
                  )}
                </div>
