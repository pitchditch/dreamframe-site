    ...
    <div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6">
        ...
        <div className="space-y-2">
          <div>
            <span className="font-medium">Address:</span> <span className="text-gray-700">{`${address.street}, ${address.city}, ${address.postalCode}` || 'Not provided'}</span>
          </div>
          <div>
            <span className="font-medium">Property Size:</span> <span className="text-gray-700">{size.houseSize || 'Not selected'}</span>
          </div>
          <div>
