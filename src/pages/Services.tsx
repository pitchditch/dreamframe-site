...
const Services = () => {
  ...
  return (
    <Layout>
      ...
      <CallToAction
        title={t("Ready to Experience Our Premium Services?")}
        subtitle={t("Contact us today to discuss your specific needs and receive a customized cleaning solution for your property.")}
      />
    </Layout>
  );
};
