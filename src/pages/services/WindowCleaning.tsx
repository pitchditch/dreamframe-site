        ...
        <ul className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8 text-gray-700">
          <li className="flex items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-sm">Our "Plaid Promise" means if you're not happy, we'll re-clean within 48 hours.</p>
            </div>
          </li>
          <li className="flex items-start">
            <span className="bg-green-500 text-white p-3 rounded-full mr-4">✔</span>
            <div>
              ...
              <p className="mt-1 text-sm">We use the same high-grade tools and purified water systems as top professionals.</p>
            </div>
          </li>
          <li className="flex items-start">
            <span className="bg-green-500 text-white p-3 rounded-full mr-4">✔</span>
            <div>
              ...
              <p className="mt-1 text-sm">Safe, biodegradable soaps and pure water leave no streaks or chemical residue.</p>
            </div>
          </li>
          <li className="flex items-start">
            <span className="bg-green-500 text-white p-3 rounded-full mr-4">✔</span>
            <div>
              ...
              <p className="mt-1 text-sm">Our trained technicians treat your home like their own, paying attention to every detail.</p>
            </div>
          </li>
          <li className="flex items-start">
            <span className="bg-green-500 text-white p-3 rounded-full mr-4">✔</span>
            <div>
              ...
              <p className="mt-1 text-sm">Clean windows make a great first impression and enhance your property's appearance.</p>
            </div>
          </li>
          <li className="flex items-start">
            <span className="bg-green-500 text-white p-3 rounded-full mr-4">✔</span>
      ...
      <section id="services" className="w-full py-16 px-6 bg-gray-100">
        ...
        <div className="max-w-4xl mx-auto text-gray-800 space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li><strong>Exterior Window Washing</strong> – hand-scrubbed and squeegeed to remove dirt and water spots.</li>
            ...
            <li><strong>Professional-Only Methods</strong> – using purified water, soft-bristle brushes, and microfiber for the best results.</li>
          </ul>
        </div>
      </section>
      ...
      <section id="process" className="w-full py-16 px-6 bg-white">
        ...
        <div className="max-w-3xl mx-auto text-gray-800 space-y-4">
          ...
          <ul className="list-decimal list-inside space-y-2">
            <li><strong>Rinse with Purified Water:</strong> First we rinse windows with deionized water that's free of minerals. This prevents streaks and spots.</li>
            <li><strong>Apply Eco-Friendly Soap:</strong> We apply a biodegradable soap solution to loosen dirt without harming plants or paint.</li>
            <li><strong>Soft Scrubbing:</strong> Any stubborn grime is scrubbed with soft bristle brushes or towels.</li>
            <li><strong>Squeegee to Dry:</strong> We squeegee each pane top-to-bottom, removing all water for a streak-free shine.</li>
            <li><strong>Detailing:</strong> Technicians hand-dry edges and wipe frames/sills clean for a flawless finish.</li>
            <li><strong>Final Inspection:</strong> We inspect each window, ensuring it sparkles like new before calling the job complete.</li>
          </ul>
        </div>
      </section>
      ...
      <section id="faq" className="w-full py-16 px-6 bg-white">
        ...
        <div className="max-w-3xl mx-auto space-y-6 text-gray-800">
          <div>
            ...
            <p>We recommend cleaning windows at least twice a year (spring and fall) to keep them looking their best. Seasonal rains and pollen can build up, so regular cleaning prolongs the life of your glass.</p>
          </div>
          <div>
            <h3 className="font-semibold">How do you prevent streaks?</h3>
            <p>By using purified (deionized) water and our special biodegradable cleaning solution, we eliminate mineral residue and streaks. Combined with proper squeegee technique, your windows come out crystal-clear.</p>
          </div>
          <div>
            <h3 className="font-semibold">Are your cleaning products safe?</h3>
            <p>Yes. We only use eco-friendly, biodegradable soaps that are gentle on plants and paint. Customers report being very pleased with our green approach and sparkling results.</p>
          </div>
        </div>
      </section>
