            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center mb-12">
                <div className="order-1 md:order-1">
                  <div className="relative overflow-hidden rounded-lg shadow-lg">
                    <img src="/lovable-uploads/baa94eb2-dd5a-4479-b809-801f52009eab.png" alt="Gutter Stick guard system protecting gutters from debris" className="w-full h-auto object-cover" />
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="order-1 md:order-2">
                  <div className="relative overflow-hidden rounded-lg shadow-lg">
                    <img src="/lovable-uploads/bb606d6a-bd92-4fa1-aceb-93bc03c8e231.png" alt="Professional installation of Gutter Stick guard system" className="w-full h-auto object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
