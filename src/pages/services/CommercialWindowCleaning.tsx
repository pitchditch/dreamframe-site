...
const CommercialWindowCleaning = () => {
  ...
  return (
    <Layout title="Commercial Window Cleaning Services | BC Pressure Washing" description="Professional window cleaning services for commercial properties in Surrey, White Rock & Metro Vancouver. Keep your business looking its best.">
      {/* Hero Section */}
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <img 
              src="/lovable-uploads/16b476d3-56e8-40c9-a1c6-7cd772e62b07.png" 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-1/2">
              <img 
                src="/lovable-uploads/10877f40-2faf-4231-bc7d-a5440a408ca2.png" 
                alt="Window cleaning maintenance" 
      ...
      <FAQSection 
        ...
        subtitle="Common questions about our commercial window cleaning services"
        faqs={faqs}
      />
