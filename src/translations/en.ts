...
const englishTranslations = {
  ...
  // House Washing Page
  "Safe, effective pressure washing services to restore your home's exterior and protect your investment.": "Safe, effective pressure washing services to restore your home's exterior and protect your investment.",
  "Revitalize Your Home's Exterior": "Revitalize Your Home's Exterior",
  "Your home's exterior faces constant exposure to the elements, resulting in the accumulation of dirt, grime, algae, mold, and other contaminants over time. These not only detract from your home's appearance but can cause long-term damage to various exterior surfaces.": "Your home's exterior faces constant exposure to the elements, resulting in the accumulation of dirt, grime, algae, mold, and other contaminants over time. These not only detract from your home's appearance but can cause long-term damage to various exterior surfaces.",
  "Our professional house washing service uses the \"soft wash\" approach – combining low pressure with specialized cleaning solutions to safely and effectively clean all exterior surfaces including vinyl siding, brick, stucco, wood, and more. This method delivers superior results while protecting delicate surfaces from damage.": "Our professional house washing service uses the \"soft wash\" approach – combining low pressure with specialized cleaning solutions to safely and effectively clean all exterior surfaces including vinyl siding, brick, stucco, wood, and more. This method delivers superior results while protecting delicate surfaces from damage.",
  "Fully Insured": "Fully Insured",
  "Prompt Service": "Prompt Service",
  "100% Satisfaction": "100% Satisfaction",
  "Our Pressure Washing Services": "Our Pressure Washing Services",
  "Professional pressure washing solutions for your home and commercial property": "Professional pressure washing solutions for your home and commercial property",
  "Benefits of Professional House Washing": "Benefits of Professional House Washing",
  "Regular exterior cleaning provides numerous advantages for your home's appearance and longevity": "Regular exterior cleaning provides numerous advantages for your home's appearance and longevity",
  "Restore Original Beauty": "Restore Original Beauty",
  "Remove years of built-up dirt, grime, algae, and mildew to reveal the original beauty of your home's exterior surfaces.": "Remove years of built-up dirt, grime, algae, and mildew to reveal the original beauty of your home's exterior surfaces.",
  "Prevent Costly Damage": "Prevent Costly Damage",
  "Regular cleaning prevents organic growth and contaminants from deteriorating your siding, brick, or other exterior materials.": "Regular cleaning prevents organic growth and contaminants from deteriorating your siding, brick, or other exterior materials.",
  "Healthier Home Environment": "Healthier Home Environment",
  "Eliminate mold, mildew, and allergens from exterior surfaces that can affect indoor air quality and trigger allergies.": "Eliminate mold, mildew, and allergens from exterior surfaces that can affect indoor air quality and trigger allergies.",
  "Increase Property Value": "Increase Property Value",
  "A clean exterior significantly enhances curb appeal and can increase your property's market value by up to 5-10%.": "A clean exterior significantly enhances curb appeal and can increase your property's market value by up to 5-10%.",
  "Prepare for Painting": "Prepare for Painting",
  "Create the perfect clean surface if you're planning to paint or stain your home's exterior in the near future.": "Create the perfect clean surface if you're planning to paint or stain your home's exterior in the near future.",
  "Safe, Eco-Friendly Process": "Safe, Eco-Friendly Process",
  "Our soft washing techniques and biodegradable cleaning solutions are safe for your home, family, pets, and landscaping.": "Our soft washing techniques and biodegradable cleaning solutions are safe for your home, family, pets, and landscaping.",
  ...
  "We carefully assess your home's exterior to determine the appropriate cleaning method and identify any areas needing special attention.": "We carefully assess your home's exterior to determine the appropriate cleaning method and identify any areas needing special attention.",
  "Soft Washing Application": "Soft Washing Application",
  "Using specialized equipment, we apply eco-friendly cleaning solutions that break down organic growth and contaminants.": "Using specialized equipment, we apply eco-friendly cleaning solutions that break down organic growth and contaminants.",
  "Thorough Rinse": "Thorough Rinse",
  "We complete the process with a gentle, thorough rinse that removes all cleaning solutions and loosened contaminants.": "We complete the process with a gentle, thorough rinse that removes all cleaning solutions and loosened contaminants.",
  "Driveway Pressure Washing": "Driveway Pressure Washing",
  "Driveway Restoration": "Driveway Restoration",
  ...
  "Removes stubborn oil and grease stains": "Removes stubborn oil and grease stains",
  "Eliminates slippery moss and algae": "Eliminates slippery moss and algae",
  "Prevents concrete deterioration": "Prevents concrete deterioration",
  "Optional sealing services available": "Optional sealing services available",
  "Request Driveway Cleaning": "Request Driveway Cleaning",
  "Additional Pressure Washing Services": "Additional Pressure Washing Services",
  "Fence Cleaning": "Fence Cleaning",
  "Restore wood, vinyl, or composite fencing to like-new condition with our specialized cleaning techniques.": "Restore wood, vinyl, or composite fencing to like-new condition with our specialized cleaning techniques.",
  "Deck & Patio Cleaning": "Deck & Patio Cleaning",
  "Safe and effective cleaning for wooden decks, composite decking, and concrete or stone patios.": "Safe and effective cleaning for wooden decks, composite decking, and concrete or stone patios.",
  "Glass Awning Cleaning": "Glass Awning Cleaning",
  "Professional glass awning and skylight cleaning to remove dirt, water spots, and debris for crystal clear results.": "Professional glass awning and skylight cleaning to remove dirt, water spots, and debris for crystal clear results."
};
