...
const punjabiTranslations = {
  ...
  "That's us! As a local exterior cleaning expert serving White Rock and the Lower Mainland, you've probably spotted our distinctive red company vehicle along Marine Drive or throughout the neighborhood.": "ਇਹ ਅਸੀਂ ਹਾਂ! ਵ੍ਹਾਈਟ ਰਾਕ ਅਤੇ ਲੋਅਰ ਮੇਨਲੈਂਡ ਦੀ ਸੇਵਾ ਕਰਨ ਵਾਲੇ ਇੱਕ ਸਥਾਨਕ ਬਾਹਰੀ ਸਫਾਈ ਵਿਸ਼ੇਸ਼ਜ್ઞ ਹੋਣ ਦੇ ਨਾਤੇ, ਤੁਸੀਂ ਸ਼ਾਇਦ ਮਰੀਨ ਡ੍ਰਾਈਵ ਜਾਂ ਸਾਰੇ ਇਲਾਕੇ ਵਿੱਚ ਸਾਡੇ ਵਿਸ਼ਿਸ਼ਟ ਲਾਲ ਕੰਪਨੀ ਵਾਹਨ ਨੂੰ ਦੇਖਿਆ ਹੋਵੇਗਾ।",
